<?php
    ...
    define('PAGE_NAME', 'IndividualUserTask.php');
    ...
    if(isset($_POST['filterbtn']) && !empty($_POST['filterbtn']))
             ...
             if(isset($_SESSION['status']) && isset($_SESSION['category']))
             {
                $taskstatus=$_SESSION['status'];
                $cat=$_SESSION['category'];
             }
    ...
    echo "<body class='dashpg'>
             ...
             <form id='Utask' method='post' action='IndividualUserTask.php' class='clearfix'>
